...
class Square:
    ...
    def __init__(self, size=0, position=(0, 0)):
        ...
        Args:
            size (int): size of the square
            position (tuple): 2 positive integers, location of the square
    ...
    @property
    def size(self):
        '''This function is used to get or access the square size
    ...
    def position(self, value):
        '''This function sets the position of the square to a new position

        Args:
            value (tuple): 2 positive integers for position
